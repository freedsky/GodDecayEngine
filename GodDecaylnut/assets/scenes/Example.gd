...
Entities:
  - Entity: 12837192831273
    TagComponent:
      Tag: Boutton
    TransformComponent:
      Translation: [-1.00613534e-07, -0.5, -0.00410291785]
      Rotation: [1.57079613, 0.785398245, -2.95027974e-07]
      Scale: [0.999999642, 0.999983609, 0.999782741]
    SpriteRendererComponent:
      Color: [0.435307413, 0.060538765, 0.505791545, 1]
  - Entity: 12837192831273
    TagComponent:
      Tag: Left
    TransformComponent:
  ...
  - Entity: 12837192831273
    TagComponent:
      Tag: Right
    TransformComponent:
      Translation: [-0.35591498, 0, -0.357914776]
