...
namespace GodDecay
{
	...
	void Renderer2D::Init()
	{
		...
		s_Data.BaseShader->SetIntArray("u_Textures", samplers, s_Data.MaxTextureSlots);
	...
	void Renderer2D::BeginScene(const Camera& camera, const glm::mat4& transform)
	{
		...
		s_Data.BaseShader->Bind();
		s_Data.BaseShader->SetMat4("u_ViewProjection", viewProj);
	...
	{
		s_Data.BaseShader->Bind();
		s_Data.BaseShader->SetMat4("u_ViewProjection", camera.GetViewProjection());
	...
	void Renderer2D::Flush()
	{
		...
		RenderCommand::DrawIndexed(s_Data.QuadVertexArray, RendererAPI::DrawType::Normal, s_Data.QuadIndexCount);
